    ...
    <div className="flex-1 space-y-8 p-8 bg-slate-50/50 dark:bg-background min-h-screen">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 auto-rows-fr">
          ...
          <Card className="p-5 border-0 shadow-sm bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-2xl hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-emerald-50">Net Profit (All Time)</h3>
              <div className="p-2 bg-white/20 rounded-full backdrop-blur-sm">
                <TrendingUp className="h-4 w-4 text-white" />
              </div>
            </div>
            <div className="text-2xl font-bold text-white">Rs {formatNumber(data.net_profit)}</div>
            <p className="text-xs text-emerald-100 mt-1 font-medium opacity-80">Based on COGS</p>
          </Card>

          <Card className="p-5 border-0 shadow-sm bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/40 dark:to-amber-950/40 rounded-2xl border border-orange-100 dark:border-orange-900/50 hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-orange-800 dark:text-orange-300">Low Stock</h3>
              <div className="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-full">
                <AlertTriangle className="h-4 w-4 text-orange-600 dark:text-orange-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-orange-700 dark:text-orange-400">{data.low_stock_count}</div>
          </Card>

          <Card className="p-5 border-0 shadow-sm bg-gradient-to-br from-rose-50 to-red-50 dark:from-rose-950/40 dark:to-red-950/40 rounded-2xl border border-rose-100 dark:border-rose-900/50 hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-rose-800 dark:text-rose-300">Out of Stock</h3>
              <div className="p-2 bg-rose-100 dark:bg-rose-900/30 rounded-full">
                <AlertCircle className="h-4 w-4 text-rose-600 dark:text-rose-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-rose-700 dark:text-rose-400">{data.out_of_stock_count}</div>
          </Card>

          <Card className="p-5 border-0 shadow-sm bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-950/40 dark:to-amber-950/40 rounded-2xl border border-yellow-200 dark:border-yellow-900/50 hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-amber-800 dark:text-amber-300">Expiring Soon</h3>
              <div className="p-2 bg-amber-100 dark:bg-amber-900/30 rounded-full">
                <Clock className="h-4 w-4 text-amber-600 dark:text-amber-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-amber-700 dark:text-amber-400">{data.expiring_soon_count}</div>
          </Card>
          ...
          <Card className="p-5 border border-border shadow-sm bg-white dark:bg-card rounded-2xl hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-muted-foreground">Total Sales (All Time)</h3>
              <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                <DollarSign className="h-4 w-4 text-blue-600 dark:text-blue-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-foreground">Rs {formatNumber(data.total_sales)}</div>
          </Card>

          <Card className="p-5 border border-border shadow-sm bg-white dark:bg-card rounded-2xl hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-muted-foreground">Total Purchases (All Time)</h3>
              <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-full">
                <Download className="h-4 w-4 text-purple-600 dark:text-purple-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-foreground">Rs {formatNumber(data.total_purchases)}</div>
          </Card>

          <Card className="p-5 border-0 shadow-sm bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/40 dark:to-blue-950/40 rounded-2xl border border-cyan-100 dark:border-cyan-900/50 hover:shadow-md transition-shadow">
            <div className="flex flex-row items-center justify-between pb-2">
              <h3 className="text-sm font-medium text-cyan-800 dark:text-cyan-300">Current Stock Value</h3>
              <div className="p-2 bg-cyan-100 dark:bg-cyan-900/30 rounded-full">
                <Wallet className="h-4 w-4 text-cyan-600 dark:text-cyan-400" />
              </div>
            </div>
            <div className="text-2xl font-bold text-cyan-700 dark:text-cyan-400">Rs {formatNumber(data.current_stock_value)}</div>
          </Card>
        </div>
      </div>
